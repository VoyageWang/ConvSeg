...
from geoseg.models.ESegformer import Segformer
...
weights_name = "Esegformer-r18-768crop-ms-e45-v13"
weights_path = "model_weights/swed/{}".format(weights_name)
test_weights_name = "esegformer-r18-768crop-ms-e45-v13"
...
#  define the network
net = Segformer(img_size=256, patch_size=4, in_chans=12, num_classes=num_classes, embed_dims=[ 40, 80, 200 ,320 ],
